...
def calc_breed(dino, weight, food):
    ...
    baby_food_points = d["food_drain"] * juv_time * weight
    juv_food_points = d["food_drain"] * (adult_time - juv_time) * weight
    
    # Convert to ITEM COUNT (like Crumplecorn shows)
    baby_food_items = baby_food_points / fv
    juv_food_items = juv_food_points / fv
    total_food_items = baby_food_items + juv_food_items
    ...
    return {
        ...
        "baby_food": baby_food_items, "juv_food": juv_food_items,
        "total_food": total_food_items,
...
class FoodSelect(Select):
    ...
    async def callback(self, i):
        ...
        # MATURATION TIMELINE - CLEAN FORMAT
        e.add_field(
        ...
        # FOOD REQUIRED - ITEM COUNT (like Crumplecorn)
        e.add_field(
